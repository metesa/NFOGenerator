<<<<<<< 7e42e6d473a5e42db17498da4dae3e648102c4bc
﻿using System;
...
namespace NFOGenerator
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            //TODO: Temporary test and the Encode problem hasn't been solved.
            NFOInfo ni = new NFOInfo("Godspeed.2016.1080p.WEB-DL.DD5.1.H.264-TAiCHi", 
                Model.General.Alignment.Middle,
                "http://www.imdb.com/title/tt5952306/",
                "iTunes - Thanks!",
                "3.94 GiB",
                "1h 51m 18s",
                "4560 Kbps - Untouched iTunes file",
                "1920 x 804",
                "24.000 fps",
                "Chinese DD5.1, 48.0 KHz, 6 channels, 384 Kbps",
                "Traditional Chinese, Simplified Chinese",
                "No",
                "No");
            NFOStyle ns = new NFOStyle();
            Dictionary<string, string> NEW = ni.MapDictionaryValue();
            NFOTemplate nt = new NFOTemplate(ni, ns);
            nt.WriteToFile(@"C:\NFO.nfo");
        }
    ...
    public partial class frmMain : Form
    {
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    audioCombined += this.lstAudio.GetItemText(i) + Environment.NewLine;
                }
                ...
                {
                    subCombined += this.lstSubtitle.GetItemText(i) + Environment.NewLine;
                }
...
>>>>>>> implemented all the nfo processing part and character encoding part
